...
#自作
from function.func_get_length import get_m
...
car_height = 1830.0
camera_resolution = 2448.0
camera_image_sencer = 3.0
camera_carrybretion = 1533.1
...
print(get_m(car_height,camera_resolution,camera_image_sencer,camera_carrybretion,height))
